...
public class MatchingRuleTest {
    ...
    public void noPrivilegesChangedTest() {
        try (Transaction ignored = persistence.createTransaction()) {
            ...
            assertTrue(updated.getUserRoles().stream().anyMatch(ur -> ur.getRole().getName().equals("Initial role")));
    ...
    private static LdapMatchingRuleContext createLdapMatchingRuleContext(LdapUser ldapUser, User user) {

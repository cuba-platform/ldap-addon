...
values
('ff2ebe74-3836-465b-9185-60141a6a0548',0,getdate(),'admin','DEFAULT','Default rule',0,0,0,'ff2ebe74-3836-465b-9185-60141a6a0548','ff2ebe74-3836-465b-9185-60141a6a0548');
...
insert into LDAP_MATCHING_RULE_ROLE_LINK (matching_rule_id, role_id) values ('ff2ebe74-3836-465b-9185-60141a6a0548', (select id from sec_role where name='ldap-administrator'));
